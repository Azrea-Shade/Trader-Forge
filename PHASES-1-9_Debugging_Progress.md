## CI Dashboard Update — 2025-09-12 19:27:37 UTC

**Run:** [CI - Single (Windows build + unit tests) (attempt 1)](https://github.com/Azrea-Shade/Trader-Forge/actions/runs/17684050146)
...
**Changelog**
- f526663 fix(ci): AlertResult flags -> bool?; EvaluateWithPrices -> (AlertResult,double?) for .HasValue
...
## CI Dashboard Update — 2025-09-12 18:27:03 UTC

**Run:** [CI - Single (Windows build + unit tests) (attempt 1)](https://github.com/Azrea-Shade/Trader-Forge/actions/runs/17682771180)  
**Branch:** `testing/1.0.0`  
**Status:** ❌ Failure  
**Progress:** `70%`  `███████░░░`
...
## CI Dashboard Update — 2025-09-12 18:23:07 UTC

**Run:** [CI - Single (Windows build + unit tests) (attempt 1)](https://github.com/Azrea-Shade/Trader-Forge/actions/runs/17682561942)  
**Branch:** `testing/1.0.0`  
**Status:** ❌ Failure  
**Progress:** `70%`  `███████░░░`
...
**Changelog**
- 1afebe5 fix(ci): AlertResult flags bool; EvaluateWithPrices returns (AlertResult,double); add double.HasValue() extension
