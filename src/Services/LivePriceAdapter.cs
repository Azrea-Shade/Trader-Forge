...
namespace Services
{
    ...
    public class LivePriceAdapter : IPriceFeed {
        ...
        public Task<double?> LastPrice(string ticker, CancellationToken ct = default) => throw new System.NotImplementedException();
        public Task<IDictionary<string, double?>> GetPricesAsync(IEnumerable<string> tickers, CancellationToken ct = default) => throw new System.NotImplementedException();
}
}
