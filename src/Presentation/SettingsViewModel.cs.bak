...
namespace Presentation
{
    public class SettingsViewModel : INotifyPropertyChanged
    {
        ...
        public SettingsViewModel(IClock clock)
            : this(new SqliteDb(),
                new Scheduler(new FileNotifier("artifacts/brief.log"), new SystemClock()), new SystemClock()), clock,
                    new BriefService(new SystemClock()))),
        ...
        public SettingsViewModel(SettingsService _)
            : this(new SqliteDb(),
                new Scheduler(new FileNotifier("artifacts/brief.log"), new SystemClock()), new SystemClock()), new SystemClock(),
                    new BriefService(new SystemClock()))),
                        new PortfolioService(new PortfoliosRepository(new SqliteDb()), new DummyPriceFeed()),
                        new SystemClock()),
                    new FileNotifier()),
